...
const hr: Translations = {
  ...
  'collection.loadMore': 'Učitaj još',
  'collection.allLoaded': 'Svi nalazi su učitani',
  ...
  'collection.dateModeDayMonth': 'Dan i mjesec',
  'collection.dateModeYear': 'Godina',
  'collection.clearDateSearch': 'Ukloni datum',
  'collection.dayMonthSearch': 'Pretraži po danu i mjesecu (svaka godina)',
  'collection.pickDate': 'Odaberi datum',
  'collection.pickMonth': 'Odaberi mjesec',
  'collection.pickDayMonth': 'Odaberi dan i mjesec',
  'collection.sortMode': 'Način sortiranja',
  'collection.sortRecent': 'Najnovije',
  'collection.sortAlphabetical': 'Abeceda',
  'collection.filtersButton': 'Filteri',
  'collection.filtersActive': 'Filteri (aktivno)',
  ...
  'settings.websiteTitle': 'Otvori website Gljivobooka',
  'settings.reportBug': 'Report bug',
  'settings.reportBugTitle': 'Otvori obrazac za prijavu buga',
  'settings.support': 'Doniraj',
  'settings.supportTitle': 'Doniraj iz dobre volje',
  ...
  'stats.fieldOutings': 'Izlasci na teren',
...
const en: Translations = {
  ...
  'collection.allLoaded': 'All finds loaded',
  ...
  'collection.dateModeDayMonth': 'Day & month',
  'collection.dateModeYear': 'Year',
  'collection.clearDateSearch': 'Clear date',
  'collection.pickDate': 'Pick date',
  'collection.pickMonth': 'Pick month',
  'collection.pickDayMonth': 'Pick day and month',
  'collection.dayMonthSearch': 'Search by day and month (every year)',
  'collection.sortMode': 'Sort order',
  'collection.sortRecent': 'Recent',
  'collection.sortAlphabetical': 'Alphabetical',
  'collection.filtersButton': 'Filters',
  'collection.filtersActive': 'Filters (active)',
  ...
  'settings.website': 'Website',
  'settings.websiteTitle': 'Open the Mushroom Book website',
  'settings.reportBug': 'Report bug',
  'settings.reportBugTitle': 'Open the bug report form',
  'settings.support': 'Donate',
  'settings.supportTitle': 'Donate if you like the app',
  ...
  'stats.fieldOutings': 'Field Outings',
