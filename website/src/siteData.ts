...
export const release = {
  ...
  notes: {
    en: [
      ...
      'Added the public website, release downloads, community links, ideas, and support planning.',
    ],
    hr: [
      ...
      'Dodan je javni website, release download, linkovi zajednice, ideje i plan podrske.',
    ],
  },
};
...
export const funding = [
  ...
  },
  {
    ...
    titleHr: 'Offline paketi karata',
    current: 0,
    goal: 900,
  },
  {
    title: 'Species wish list',
    titleHr: 'Popis vrsta koje zelis pronaci',
    current: 0,
    goal: 500,
  },
  {
    title: 'Large library mode',
    titleHr: 'Rad s velikim zbirkama',
    current: 0,
    goal: 1200,
  },
];
